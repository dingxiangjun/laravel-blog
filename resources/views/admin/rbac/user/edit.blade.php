            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal layui-form" id="form" action="{{route('admin.rbac.adminUser.update',$admin->id)}}">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">用户名</label>
                                <div class="col-sm-10">
                                    <input type="text" lay-verify="required" class="form-control" value="{{$admin->name}}" name="name">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" lay-verify="required" value="{{$admin->email}}" class="form-control" name="email">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                                ...
                                                <div class="i-checks">
                                                    <label class="">
                                                        <div class="icheckbox_square-green"  style="position: relative;">
                                                            <input type="checkbox" name="roles[]" {{in_array($role['id'],$rolesArr) ? 'checked' : ''}} value="{{$role->id}}" style="position: absolute; opacity: 0;">
