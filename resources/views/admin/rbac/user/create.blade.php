                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal layui-form" id="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" lay-verify="required" class="form-control" name="email">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                                ...
                                                <div class="i-checks">
                                                    <label class="">
                                                        <div class="icheckbox_square-green" style="position: relative;">
                                                            <input type="checkbox" name="roles[]" value="{{$role->id}}" style="position: absolute; opacity: 0;">
                                                        ...
                                                        @foreach($data['items'] as $value)
                                                            <div class="col-md-2">
                                                                <div class="i-checks">
                                                                    <label class="">
                                                                        <div class="icheckbox_square-green" style="position: relative;">
                                                                            <input type="checkbox" name="permissions[]" value="{{$value['id']}}" style="position: absolute; opacity: 0;">
    ...
    <script>
        ...
        layui.use(['layer', 'form', 'element', 'upload'], function () {
            ...
            form.on('submit(submit)', function (data) {
                ...
                $.ajax({
                    url: '{{route('admin.rbac.adminUser.store')}}',
                    type: 'POST',
                    dataType: 'json',
                    data: data,
                    error: function (data) {
