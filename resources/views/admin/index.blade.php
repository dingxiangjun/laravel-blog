...
@section('css')
    <!-- Morris -->
    <link href="/vendor/hplus/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <!-- Gritter -->
    <link href="/vendor/hplus/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
@endsection
...
@section('js')
    <!-- Flot -->
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.js"></script>
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/vendor/hplus/js/plugins/flot/jquery.flot.symbol.js"></script>
    ...
    <!-- jQuery UI -->
    <script src="/vendor/hplus/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="/vendor/hplus/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/vendor/hplus/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- EayPIE -->
    <script src="/vendor/hplus/js/plugins/easypiechart/jquery.easypiechart.js"></script>

    <!-- Sparkline -->
    <script src="/vendor/hplus/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/vendor/hplus/js/demo/sparkline-demo.js"></script>
